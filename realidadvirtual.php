...
<div id="imgContent">
        ...
        <p id="izq">SOLUCIONES</p><p id="izq2">REALES</p>
        <p id="der">EN REALIDAD</p><p id="der2">VIRTUAL</p>
</div>
<div id="myCarousel" class="carousel slide mt-4 mb-6 h-auto" data-bs-ride="carousel">
    <div id="cuadro" class="w-75 p-4 rounded shadow">
        <p class="lead">¿Quieres conocernos mejor?</p>
        <a href="#" class="btn btn-primary btn-lg mt-3">
            <span class="icono"><i class="fas fa-arrow-right"></i></span> Visita nuestra web
        </a>
    </div>
</div>
<div class="container-fluid pt-5">
    <h2 class="text-center">VIDAREAL</h2>
    <div id="columnas" class="row row-cols-sg-1 row-cols-lg-2 pt-2">
...
<script src="vista/js/realidadvirtual.js"></script>
