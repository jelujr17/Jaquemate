<?php include 'vista/layout/cabecera.php'; ?>
    ...
    <div class="p-5 pb-0 uno mt-2">
        <div class="container-fluid py-5 ds2 dos">
            ...
            <p class="col-ld-8">Estamos aquí para ayudarte en todo lo que necesites. Si tienes alguna pregunta,
                comentario o consulta, no dudes en ponerte en contacto con nosotros. <br> Puedes enviarnos un correo
    ...
    <div id="iconos" class="row row-cols-sg-1 row-cols-lg-2 g-5 start-50 h-auto mx-auto w-75">
        ...
        <div class="col-ld-6">
            <div class="h-100 p-4 bg-body-tertiary border rounded-3">
                <div class="d-flex justify-content-center align-items-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="bi bi-map" viewBox="0 0 16 16">
