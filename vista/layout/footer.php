...
<footer class="bg-dark text-white pt-5 pb-4 mt-5">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12 col-lg-4 mt-3 text-center" id = "opcionesContactos">
        <h5 class="text-uppercase mb-2 font-weight-bold text-warning" id="contactoTitle">Contacto</h5>
        <div id="contactoOptions" class="footer-options">
          <p>
            <i class="fas fa-calendar mr-3"></i> L-V: 9:00/14:00
          </p>
          <p id = "correo">
			  <i class="fas fa-envelope mr-3"></i><img src="vista/assets/correo.png">
          </p>
			<p id= "telefono">
            <i class="fas fa-phone mr-3"></i> <img src="vista/assets/telefono.png">
			</p>
        </div>
      </div>
    </div>
