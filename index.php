...
<div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-5 py-5 top-50 start-50 translate-middle-x h-50 divSecundario">
      <div class="col appear-from-bottom">
        <div class="card card-cover h-75 overflow-hidden text-bg-dark rounded-4 shadow-lg opacidad">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-graph-up-arrow" viewBox="0 0 16 16">
            ...
            <h3 class="pt-1 display-6 fw-bold">Potencia tu marca</h3>
      ...
      <div class="col appear-from-bottom">
        <div class="card card-cover h-75 overflow-hidden text-bg-dark rounded-4 shadow-lg opacidad">
          ...
          <h3 class="pt-1 display-6 fw-bold">Realidad virtual</h3>
            <ul class="d-flex list-unstyled mt-auto">
              <li class="me-auto">holac aasdasd adsd </li>
            </ul>
          </div>
      ...
      <div class="col appear-from-bottom">
        <div class="card card-cover h-75 overflow-hidden text-bg-dark rounded-4 shadow-lg opacidad">
          ...
          <h3 class="pt-1 display-6 fw-bold">Soluciones digitales</h3>
          <ul class="d-flex list-unstyled mt-auto">
              <li class="me-auto">holac aasdasd adsd </li>
            </ul>
          </div>
...
<div class="container-fluid mt-5 pt-5 fondo pb-5">
<div class="row row-cols-1 row-cols-lg-3 g-3">
  <div class="col">
    <div class="card shadow-sm contenido">
    <div class="d-flex align-items-center position-relative">
      <div class="diagonal-bg position-absolute top-0 bottom-0 start-0 end-50"></div>
